...
/*
ACLARACIÓN IMPORTANTE: ojo que este es solo un ejemplo, en un caso real tanto la cadena como el caracter a contar 
deberían ser ingresados por teclado, nosotros no lo hacemos así para no extender el video.
*/
